...
14. `docs/14_CLOUD_DEPLOYMENT_PLAN.md` — kế hoạch Vercel, Render, Supabase PostGIS,
    R2, CI/CD, backup và cutover production.
15. `docs/SESSION_HANDOFF.md` — bàn giao ngắn để tiếp tục nhanh ở phiên sau.
